...
export class WindowsAgentStopNotificationService {
  private readonly getWindowTitle: () => string
  ...
  constructor(options: WindowsAgentStopNotificationServiceOptions) {
    this.getWindowTitle = options.getWindowTitle
    this.adapter = options.adapter
    this.platform = options.platform ?? process.platform
    this.getWindowState = options.getWindowState
    this.onDidChangeWindowState = options.onDidChangeWindowState
    this.executeCommand = options.executeCommand
    this.focusWindow = options.focusWindow
