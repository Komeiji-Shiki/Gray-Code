import { jsonToConfig, configToJson, type McpServerJsonEntry } from './jsonConfig';
/**
...
export class VSCodeFileSystemMcpStorageAdapter implements McpStorageAdapter {
     ...
     */
    private jsonToConfig(id: string, json: McpServerJsonEntry): McpServerConfig { return jsonToConfig(id, json); }

    /**
     * 将 McpServerConfig 转换为 JSON 格式
     * 输出简化格式（省略可推断的字段）
     */
    private configToJson(config: McpServerConfig): McpServerJsonEntry { return configToJson(config); }
