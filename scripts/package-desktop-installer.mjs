...
const args = ['pack', '--packId', 'GrayCode', '--packTitle', 'GrayCode', '--packAuthors', 'GrayCode contributors',
  '--packVersion', pkg.version, '--packDir', source, '--mainExe', 'GrayCode.exe', '--runtime', 'win-x64',
  '--channel', 'win-x64', '--outputDir', output, '--icon', path.join(root, 'resources/icon.ico'),
  '--noPortable', 'true', '--shortcuts', 'StartMenuRoot'];
