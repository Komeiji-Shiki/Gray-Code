...
export type SettingsTab = 'channel' | 'development' | 'tools' | 'autoExec' | 'mcp' | 'checkpoint' | 'summarize' | 'imageGen' | 'dependencies' | 'context' | 'prompt' | 'tokenCount' | 'subagents' | 'sound' | 'appearance' | 'memory' | 'general' | 'usage' | 'discord' | 'onebot' | 'accounts' | 'workspaces' | 'remote'
