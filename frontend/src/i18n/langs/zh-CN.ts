        ...
        channels: {
            ...
            openai: {
                ...
                thinking: {
                    ...
                    effortHint: 'none: 不使用 | low: 较少 | medium: 中等 | high: 较多 | xhigh: 最高 | max: 最大 | ultra: 极限 | custom: 自定义',
                    effortNone: '无',
                    effortMinimal: '极少',
                    effortLow: '低',
                    effortMedium: '中',
            ...
            'openai-responses': {
                ...
                thinking: {
                    effortLabel: '思考强度 (Effort)',
                    effortHint: 'none: 不使用 | minimal: 极少 | low: 较少 | medium: 中等 | high: 较多 | xhigh: 极高 | max: 最大 | ultra: 极限 | custom: 自定义',
                    effortNone: '无 (none)',
