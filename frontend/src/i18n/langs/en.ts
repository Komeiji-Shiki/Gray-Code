    ...
    components: {
        ...
        settings: {
            ...
            subagents: {
                ...
                defaultMaxRuntimeSecondsHint: 'Used by configured agents without their own limit. Default 1800 seconds (30 minutes) per run, including model and tool waits but excluding the initial queue. Increase for longer tasks; -1 means unlimited.',
                ...
                generalWorkerMaxRuntimeSecondsHint: 'Initially 2400 seconds (40 minutes). Use 7200 (2 hours) for longer work, or lower it for short tasks. -1 means unlimited runtime. An explicit model override takes priority. Default changes affect subsequent dispatches.',
                basicInfo: 'Basic Info',
                ...
                maxRuntimeHint: 'Override the time limit per run, including model and tool waits. -1 means unlimited.',
