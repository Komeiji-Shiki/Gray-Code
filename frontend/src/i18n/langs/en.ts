    ...
    components: {
        ...
        settings: {
            ...
            subagents: {
                ...
                defaultMaxRuntimeSecondsHint: 'Max wall-clock runtime for sub-agents and General Worker without their own maxRuntime (-1 for unlimited, default 1800 = 30 min)',
