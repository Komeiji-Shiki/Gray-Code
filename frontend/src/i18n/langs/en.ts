    ...
    components: {
        ...
        settings: {
            ...
            subagents: {
                ...
                generalWorkerHint: 'Lets the main model dispatch General Worker without prior setup, inheriting its model and available tools. Global concurrency, queue and iteration limits apply. Each run currently has a fixed 2400-second (40-minute) runtime limit.',
                basicInfo: 'Basic Info',
