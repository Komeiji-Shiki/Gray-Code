<script lang="ts">
/**
 * 中展开裁剪提示按 messageId 记忆（模块级）——实现已外移 mediumTrimState.ts（S4 批次），
 * 此处仅 re-export 保持 .vue 具名导出兼容。
 */
export { mediumTrimmedByMessageId, MEDIUM_TRIMMED_CAP, pruneMediumTrimmedByMessageId } from './mediumTrimState'
</script>
...
import { mediumTrimmedByMessageId, MEDIUM_TRIMMED_CAP } from './mediumTrimState'
